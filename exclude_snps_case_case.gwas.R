...
png(paste0("/data/home/hmy117/ADAMS/genotypes/QMUL_Aug_23/outputs/fisher_case_case_delta_af_plot_",anc,".png"),res=900,units="in",width=6,height=4)
...
write_tsv(
    ...
    dplyr::select(SNP),
    paste0("/data/home/hmy117/ADAMS/genotypes/QMUL_Aug_23/snps_to_keep_case_case_gwas_",anc)
    )
